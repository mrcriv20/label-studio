const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./Editor-BiAiBJ4T.js","./LabelPreview-Db85w8rT.js","./DesignLabelSvg-BAkSpZGR.js","./save-BQ9KVetB.js","./SheetBuilder-D8UEHHV6.js","./Settings-qojeBg3D.js","./download-BTvVv-0_.js","./Designer-B9ui_9wH.js"])))=>i.map(i=>d[i]);
...
function Nav({ current, onNavigate }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "sidebar", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sidebar-brand", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logo, alt: "Tillie Print logo", className: "sidebar-brand-logo" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sidebar-sep" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "sidebar-nav", "aria-label": "Primary navigation", children: [
      items.slice(0, 4).map(({ id: id2, label, Icon: Icon2 }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          onClick: () => onNavigate(id2),
          className: `nav-item${current === id2 ? " active" : ""}`,
          "aria-current": current === id2 ? "page" : void 0,
          title: label,
          children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sidebar-nav-secondary", "aria-label": "Support and settings", children: items.slice(4).map(({ id: id2, label, Icon: Icon2 }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          onClick: () => onNavigate(id2),
          className: `nav-item${current === id2 ? " active" : ""}`,
...
function RollPrintDialog({ product, onClose }) {
  ...
  const printerSelectRef = reactExports.useRef(null);
  ...
  reactExports.useEffect(() => {
    ...
    function onKeyDown(event) {
      ...
      const focusable = Array.from(dialogRef.current.querySelectorAll("button:not([disabled]), select:not([disabled]), input:not([disabled])"));
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 4 }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { id: "roll-print-title", style: { fontSize: 14, fontWeight: 600, color: "var(--color-workbench-navy)", margin: 0, display: "flex", alignItems: "center", gap: 6 }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Printer, { size: 15 }),
                " Print to Roll"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { ref: closeButtonRef, onClick: onClose, className: "btn btn-icon", "aria-label": "Close print dialog", title: "Close", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 14 }) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { id: "roll-print-product", style: { fontSize: 12, color: "var(--color-text-secondary)", margin: "0 0 16px" }, children: product.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 14 }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "label-text", htmlFor: "roll-printer", children: "Printer" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { ref: printerSelectRef, id: "roll-printer", className: "input", value: printerName, onChange: (e) => setPrinterName(e.target.value), children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: 11, color: "var(--color-text-muted)", marginTop: 5 }, children: "Pick your roll printer (e.g. UniNet iColor) to print directly with no dialog." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "label-text", htmlFor: "roll-size", children: "Label size" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { id: "roll-size", className: "input", value: presetId, onChange: (e) => setPresetId(e.target.value), children: [
                ...
                presetId === "custom" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 8, marginTop: 8, alignItems: "center" }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("input", { "aria-label": "Custom label width in inches", className: "input", style: { maxWidth: 90 }, inputMode: "decimal", value: customW, onChange: (e) => setCustomW(e.target.value), placeholder: "Width" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 12, color: "var(--color-text-muted)" }, children: "×" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("input", { "aria-label": "Custom label height in inches", className: "input", style: { maxWidth: 90 }, inputMode: "decimal", value: customH, onChange: (e) => setCustomH(e.target.value), placeholder: "Height" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 12, color: "var(--color-text-muted)" }, children: "inches" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: 11, color: "var(--color-text-muted)", marginTop: 5 }, children: "The label design scales to fit and rotates automatically if the media orientation differs. Set the same size as the media loaded in the printer." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "label-text", htmlFor: "roll-copies", children: "Copies" }),
              ...
              done && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { role: "status", "aria-live": "polite", className: "status-message", style: { background: "var(--color-success-surface)", border: "1px solid var(--color-success-border)", borderRadius: 8, padding: "10px 14px", fontSize: 12.5, color: "var(--color-success-text)" }, children: "Print request completed. Check the printer to confirm the label finished successfully." }),
...
function wrappedLineCount(value, maxChars) {
...
function lineIssue(field, label, value, maxChars, maxLines) {
...
function assessProductContentFit(product) {
  ...
  return issues.filter((issue) => Boolean(issue));
}
function assessOutputEligibility(entries) {
  return entries.flatMap(
    ({ product, slot }) => assessProductContentFit(product).filter((issue) => issue.status === "clipped").map((issue) => ({
      ...issue,
...
function outputEligibilityError(entries, action) {
...
function readTillieFreshness() {
  try {
    const value = JSON.parse(localStorage.getItem(FRESHNESS_KEY) || "null");
...
function recordTillieSyncSuccess(at = (/* @__PURE__ */ new Date()).toISOString()) {
  const value = { state: "fresh", lastSuccessAt: at, failedAt: null, message: "", acknowledgedFailureAt: null };
  try {
    localStorage.setItem(FRESHNESS_KEY, JSON.stringify(value));
  } catch {
  }
  return value;
}
function recordTillieSyncFailure(message) {
...
function confirmUsingSavedTillieData(products) {
...
Continue using the saved names, prices, and barcodes?`);
  ...
  try {
    localStorage.setItem(FRESHNESS_KEY, JSON.stringify(acknowledged));
  } catch {
  }
  return true;
}
function Library({ onEdit, onOpenSheet }) {
  ...
  const [selectionNotice, setSelectionNotice] = reactExports.useState("");
  const [operationNotice, setOperationNotice] = reactExports.useState("");
  const [operationError, setOperationError] = reactExports.useState("");
  const [freshness, setFreshness] = reactExports.useState(() => readTillieFreshness());
  const [syncRetrying, setSyncRetrying] = reactExports.useState(false);
  ...
  const syncTillie = reactExports.useCallback(async (cancelled) => {
  ...
  function toggleProductSelection(id2) {
    setSelectedIds((current) => {
      const next = new Set(current);
      if (next.has(id2)) next.delete(id2);
      else if (next.size < 8) next.add(id2);
      else setSelectionNotice("A PLS780 sheet holds eight labels. Clear one selection before adding another.");
      return next;
    });
  }
  function toggleAllVisible() {
    const visibleIds = sortedProducts.map(({ id: id2 }) => id2);
    const allSelected = visibleIds.length > 0 && visibleIds.every((id2) => selectedIds.has(id2));
    setSelectedIds((current) => {
      const next = new Set(current);
      visibleIds.forEach((id2) => {
        if (allSelected) next.delete(id2);
        else if (next.size < 8) next.add(id2);
      });
  ...
  const selectedProducts = products.filter(({ id: id2 }) => selectedIds.has(id2));
  ...
  async function handleImport() {
    ...
    setImporting(false);
    if (!result.ok) {
      setOperationError(`Import failed: ${result.error}. Check the file and try again.`);
      return;
    }
...
…and ${skipped.length - 10} more` : ""}`;
  ...
  async function handleExportPDF(product) {
    ...
    if (eligibilityError) {
      setOperationError(eligibilityError);
      return;
    }
  ...
  function openRollPrint(product) {
  ...
  function openSheet(productsToPrint) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "screen", style: { display: "flex", flexDirection: "column", gap: 20, minHeight: 0 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "library-header", style: { display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 12 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { style: { fontSize: 22, fontWeight: 700, color: "var(--color-workbench-navy)", margin: 0 }, children: "Products" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { fontSize: 13, color: "var(--color-text-secondary)", marginTop: 3 }, children: [
          products.length,
          " product",
          products.length !== 1 ? "s" : "",
          " in your library"
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "library-header-actions", style: { display: "flex", gap: 8, alignItems: "center" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: load, className: "btn btn-icon", title: "Refresh", "aria-label": "Refresh product library", children: /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { size: 13 }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => openSheet(selectedProducts), className: "btn-outline btn-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Printer, { size: 13 }),
          " ",
          selectedProducts.length ? `Print Sheet (${selectedProducts.length})` : "Blank Print Sheet"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => onEdit(), className: "btn-primary", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { size: 14 }),
          " New Label"
        ] })
      ] })
    ] }),
    selectionNotice && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { role: "status", className: "status-message", style: { padding: "8px 12px", background: "var(--color-warning-surface)", color: "var(--color-warning)", border: "1px solid var(--color-warning-border)", borderRadius: 8, fontSize: 12 }, children: selectionNotice }),
    operationNotice && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { role: "status", "aria-live": "polite", className: "status-message", style: { display: "flex", gap: 10, alignItems: "center", padding: "8px 12px", background: "var(--color-success-surface)", color: "var(--color-success-text)", border: "1px solid var(--color-success-border)", borderRadius: 8, fontSize: 12 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { flex: 1 }, children: operationNotice }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn-ghost btn-sm", onClick: () => setOperationNotice(""), children: "Dismiss" })
    ] }),
    operationError && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { role: "alert", className: "status-message", style: { display: "flex", gap: 10, alignItems: "center", padding: "8px 12px", background: "var(--color-danger-surface)", color: "var(--color-danger-text)", border: "1px solid var(--color-danger-border)", borderRadius: 8, fontSize: 12 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { flex: 1 }, children: operationError }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn-ghost btn-sm", onClick: () => setOperationError(""), children: "Dismiss" })
    ] }),
    hasTillieLinkedProducts && freshness?.state === "stale" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { role: "alert", className: "status-message sync-freshness is-stale", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { size: 15 }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Offline — using saved Tillie data" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
          freshness.lastSuccessAt ? `Last successful sync: ${new Date(freshness.lastSuccessAt).toLocaleString()}.` : "No successful sync time is available.",
          " Output from linked products requires acknowledgment."
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", className: "btn-outline btn-sm", onClick: () => void syncTillie(), disabled: syncRetrying, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { size: 12, className: syncRetrying ? "spin" : void 0 }),
        syncRetrying ? "Retrying…" : "Retry sync"
      ] })
    ] }),
    hasTillieLinkedProducts && freshness?.state === "fresh" && freshness.lastSuccessAt && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { role: "status", className: "sync-freshness is-fresh", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { size: 14 }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
        "POS data verified ",
        new Date(freshness.lastSuccessAt).toLocaleString(),
        "."
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "relative" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { size: 14, style: { position: "absolute", left: 12, top: "50%", transform: "translateY(-50%)", color: "var(--color-text-muted)", pointerEvents: "none" } }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          id: "product-search",
    ...
    categories.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 6, flexWrap: "wrap", alignItems: "center" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Tag, { size: 12, style: { color: "var(--color-text-muted)", flexShrink: 0 } }),
      [{ id: "__all__", label: "All" }, ...categories.map((c) => ({ id: c, label: c }))].map(({ id: id2, label }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          style: {
            ...
            cursor: "pointer",
            transition: "all 0.1s",
            borderColor: activeCategory === id2 ? "var(--color-action-blue)" : "var(--color-border)",
            background: activeCategory === id2 ? "var(--color-action-blue)" : "white",
            color: activeCategory === id2 ? "white" : "var(--color-text-secondary)"
          },
          children: [
            label,
    ...
    tillieNotice && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { role: "status", "aria-live": "polite", className: "status-message", style: { display: "flex", alignItems: "center", gap: 10, background: "var(--color-success-surface)", border: "1px solid var(--color-success-border)", borderRadius: 10, padding: "10px 16px", fontSize: 13, color: "var(--color-success-text)" }, children: [
    ...
    error && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { role: "alert", className: "status-message", style: { background: "var(--color-danger-surface)", border: "1px solid var(--color-danger-border)", borderRadius: 10, padding: "12px 16px", fontSize: 13, color: "var(--color-danger-text)" }, children: error }),
    loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { flex: 1, display: "flex", alignItems: "center", justifyContent: "center", color: "var(--color-text-muted)", fontSize: 13, paddingTop: 60 }, children: "Loading products…" }) : sortedProducts.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", style: { padding: "60px 24px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", gap: 8 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Store, { size: 38, strokeWidth: 1.6, "aria-hidden": "true", style: { color: "var(--color-market-green)" } }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontWeight: 600, color: "var(--color-workbench-navy)", margin: 0 }, children: query || activeCategory !== "__all__" ? "No products match your filter" : "No products yet" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: 13, color: "var(--color-text-muted)", marginTop: 2 }, children: query || activeCategory !== "__all__" ? "Try clearing the search or selecting a different category." : "Create your first product label to get started." }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { style: { position: "sticky", top: 0, zIndex: 1 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { style: { borderBottom: "1px solid #f1f5f9", background: "var(--color-neutral-canvas)" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { style: { width: 42, padding: "10px 8px 10px 16px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "checkbox",
            "aria-label": "Select all visible products",
            checked: sortedProducts.length > 0 && sortedProducts.every(({ id: id2 }) => selectedIds.has(id2)),
            onChange: toggleAllVisible
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { "aria-sort": sortKey === "name" ? sortDirection === "asc" ? "ascending" : "descending" : "none", style: { textAlign: "left", padding: "10px 16px", fontSize: 11, fontWeight: 600, color: "#526173", textTransform: "uppercase", letterSpacing: "0.06em" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: () => toggleSort("name"), style: sortButtonStyle, children: [
          "Product ",
          renderSortIcon("name")
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "library-secondary-column", "aria-sort": sortKey === "category" ? sortDirection === "asc" ? "ascending" : "descending" : "none", style: { textAlign: "left", padding: "10px 16px", fontSize: 11, fontWeight: 600, color: "#526173", textTransform: "uppercase", letterSpacing: "0.06em" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: () => toggleSort("category"), style: sortButtonStyle, children: [
          "Category ",
          renderSortIcon("category")
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { "aria-sort": sortKey === "price" ? sortDirection === "asc" ? "ascending" : "descending" : "none", style: { textAlign: "left", padding: "10px 16px", fontSize: 11, fontWeight: 600, color: "#526173", textTransform: "uppercase", letterSpacing: "0.06em" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: () => toggleSort("price"), style: sortButtonStyle, children: [
          "Price ",
          renderSortIcon("price")
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "library-secondary-column", "aria-sort": sortKey === "barcodeValue" ? sortDirection === "asc" ? "ascending" : "descending" : "none", style: { textAlign: "left", padding: "10px 16px", fontSize: 11, fontWeight: 600, color: "#526173", textTransform: "uppercase", letterSpacing: "0.06em" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: () => toggleSort("barcodeValue"), style: sortButtonStyle, children: [
          "Barcode ",
          renderSortIcon("barcodeValue")
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "library-secondary-column", "aria-sort": sortKey === "updatedAt" ? sortDirection === "asc" ? "ascending" : "descending" : "none", style: { textAlign: "left", padding: "10px 16px", fontSize: 11, fontWeight: 600, color: "#526173", textTransform: "uppercase", letterSpacing: "0.06em" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: () => toggleSort("updatedAt"), style: sortButtonStyle, children: [
          "Modified ",
          renderSortIcon("updatedAt")
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { style: { textAlign: "right", padding: "10px 16px", fontSize: 11, fontWeight: 600, color: "#526173", textTransform: "uppercase", letterSpacing: "0.06em" }, children: "Actions" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: sortedProducts.map((p2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "tr",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { style: { width: 42, padding: "11px 8px 11px 16px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "checkbox",
                "aria-label": `Select ${p2.name} for a print sheet`,
                checked: selectedIds.has(p2.id),
                onChange: () => toggleProductSelection(p2.id)
              }
            ) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { style: { padding: "11px 16px" }, children: [
              ...
              assessProductContentFit(p2).some((issue) => issue.status === "clipped") && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "fit-inline-badge", onClick: () => onEdit(p2), title: "Open this label to repair clipped content", children: "Content needs attention" }),
              p2.tillieProductId && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sr-only", children: " · Linked to Tillie POS" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "library-secondary-column", style: { padding: "11px 16px", color: "var(--color-text-strong-secondary)" }, children: p2.category || "Uncategorized" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { style: { padding: "11px 16px", color: "var(--color-text-strong-secondary)", fontFamily: "monospace" }, children: p2.price }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "library-secondary-column", style: { padding: "11px 16px", color: "var(--color-text-muted)", fontFamily: "monospace", fontSize: 11 }, children: p2.barcodeValue }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "library-secondary-column", style: { padding: "11px 16px", color: "var(--color-text-muted)", fontSize: 12 }, children: fmtDate(p2.updatedAt) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { style: { padding: "11px 16px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", justifyContent: "flex-end", alignItems: "center", gap: 4 }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => onEdit(p2), className: "btn-ghost btn-sm", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Pen, { size: 13 }),
                " Edit"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => openSheet([p2]), className: "btn-outline btn-sm", title: assessProductContentFit(p2).some((issue) => issue.status === "clipped") ? "Open the sheet and repair content before printing" : "Build a print sheet", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Printer, { size: 13 }),
                " Print"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("details", { className: "row-actions-menu", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("summary", { className: "btn btn-icon", "aria-label": `More actions for ${p2.name}`, title: "More actions", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Ellipsis, { size: 14 }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "row-actions-popover", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => handleDuplicate(p2.id), children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Copy, { size: 13 }),
                    " Duplicate product"
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => handleExportPDF(p2), disabled: exporting === p2.id, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { size: 13 }),
                    " Export label PDF"
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => openRollPrint(p2), children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Sticker, { size: 13 }),
                    " Print roll label"
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => handleDelete(p2.id), disabled: deleting === p2.id, className: "danger", children: [
...
function fontFamilyFor(id2) {
  return `"LabelFont-${css(id2)}", Arial, sans-serif`;
}
function css(value) {
  return value.replace(/[^a-z0-9_-]/gi, "-");
}
const Editor = reactExports.lazy(() => __vitePreload(() => import("./Editor-BiAiBJ4T.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0, import.meta.url));
const SheetBuilder = reactExports.lazy(() => __vitePreload(() => import("./SheetBuilder-D8UEHHV6.js"), true ? __vite__mapDeps([4,1,2]) : void 0, import.meta.url));
const Settings = reactExports.lazy(() => __vitePreload(() => import("./Settings-qojeBg3D.js"), true ? __vite__mapDeps([5,6,3]) : void 0, import.meta.url));
const HowTo = reactExports.lazy(() => __vitePreload(() => import("./HowTo-xAdtmTeA.js"), true ? [] : void 0, import.meta.url));
const Designer = reactExports.lazy(() => __vitePreload(() => import("./Designer-B9ui_9wH.js"), true ? __vite__mapDeps([7,2,6,3]) : void 0, import.meta.url));
function App() {
  ...
  reactExports.useEffect(() => {
    function protectWindowClose(event) {
  ...
  function backToDraftSheet() {
    if (!canLeaveWorkspace()) return;
    finishSheetRepair();
  }
  function openDesigner(designId) {
    if (!canLeaveWorkspace()) return;
    setHasUnsavedWork(false);
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "content-area", id: "main-content", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { role: "status", className: "screen app-loading", children: "Loading workspace…" }), children: [
      ...
      screen === "editor" && /* @__PURE__ */ jsxRuntimeExports.jsx(
        Editor,
        {
          ...
          onReturnToSheet: sheetRepair ? finishSheetRepair : void 0
        }
      ),
      screen === "designer" && /* @__PURE__ */ jsxRuntimeExports.jsx(Designer, { initialDesignId: designerTarget, onDirtyChange: setHasUnsavedWork }),
      ...
      screen === "how-to" && /* @__PURE__ */ jsxRuntimeExports.jsx(HowTo, { onNavigate: setScreen })
    ] }) })
  ] });
}
...
export {
  ...
  Tag as T,
  Upload as U,
  VERTICAL_INFO_LABEL_ZONES as V,
  X,
  __vitePreload as _,
  ArrowUp as a,
  CircleCheck as b,
  Copy as c,
  LOGO_ONLY_LABEL_ZONES as d,
  Layers as e,
  Printer as f,
  RollPrintDialog as g,
  Settings$1 as h,
  Sticker as i,
  Store as j,
  Trash2 as k,
  applyFontSettings as l,
  assessProductContentFit as m,
  confirmUsingSavedTillieData as n,
  createLucideIcon as o,
  fontFamilyFor as p,
  getDefaultExportFromCjs as q,
  getLabelTemplate as r,
  installFonts as s,
  jsxRuntimeExports as t,
  outputEligibilityError as u,
  reactExports as v,
  recordTillieSyncFailure as w,
  recordTillieSyncSuccess as x,
  toPercentHeight as y,
  toPercentTop as z
};
